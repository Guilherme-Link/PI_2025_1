        ...
        <div class="tableWrapper">
          ...
          @foreach ($fornec as $fornecedor)
            <tr>
              ...
              <td><a href="{{ route('fornecedor.edit',$fornecedor) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
